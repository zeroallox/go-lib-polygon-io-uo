...
//                    }`)
//
//results, err := parseResponseBody(src, ar)
//require.NoError(t, err)
//require.Nil(t, results)
//
//require.Equal(t, true, ar.IsError())
//require.Equal(t, "1", ar.ErrorCode())
//require.Equal(t, expectedErrorString, ar.ErrorString())
//
//ar = new(Response)
//src = []byte(`
//                    {
...
//
//require.Equal(t, true, ar.IsError())
//require.Equal(t, "001", ar.ErrorCode())
//require.Equal(t, expectedErrorString, ar.ErrorString())
//
//ar = new(Response)
//src = []byte(`
